  ...
  <section class="content-header">					
    <div class="container-fluid my-2">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <h1>Users <a href="{{route('users.export')}}" style="font-size: 1.7rem">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <div class="card-title">
            <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{route("users.index")}}'">
              Reset</button>
          </div>
                  ...
                  @endif
                    ...
                    <a href="{{route('users.edit',$user->id)}}">
                      <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        <a href="#" onclick="deleteUser({{$user->id}})" class="btn w-4 h-1 mr-1 p-0">
