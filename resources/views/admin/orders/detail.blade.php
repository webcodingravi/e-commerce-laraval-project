                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              @endforeach
                                ...
                                <tr>
                                  <th colspan="3" class="text-right">Discount: {{!empty($order->coupen_code) ? '('.$order->coupen_code.')' : ''}}</th>
                  ...
                  <form action="" method="post" id="changeOrderStatusForm" name="changeOrderStatusForm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" value="{{$order->shipped_date}}" class="form-control" id="shipped_date" name="shipped_date" placeholder="Shipped Date">
                      </div>
