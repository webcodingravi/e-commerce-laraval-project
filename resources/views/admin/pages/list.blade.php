    ...
    <div class="container-fluid my-2">
      <div class="row mb-2">
        ...
        <div class="col-sm-6 text-right">
          <a href="{{route('pages.create')}}" class="btn btn-primary">New Pages</a>
        </div>
      ...
      <div class="card">
        ...
        <div class="card-header">
          <div class="card-title">
            <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{route("pages.index")}}'">
              Reset</button>
          </div>
          ...
          <table class="table table-bordered table-striped table-hover text-nowrap">
            ...
            <tbody>
                ...
                <td>{{$page->slug}}</td>
                    ...
                    <a href="{{route('pages.edit',$page->id)}}">
                      <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        <a href="#" onclick="deletePage({{$page->id}})" class="btn w-4 h-1 mr-1 p-0">
             ...
             @endforeach
              ...
              @else
              <tr>
                <td colspan="6"><h5>No, Record Found</h5></td>
              </tr>
