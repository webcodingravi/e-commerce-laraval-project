...
<section class="content-header">					
  <div class="container-fluid my-2">
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <h1>Products <a href="{{route('product.export')}}" style="font-size: 1.7rem">
    ...
    <div class="card">
      ...
      <div class="card-header">
        <div class="card-title">
          <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{route("products.index")}}'">
            Reset</button>
        </div>
             ...
             @if ($products->isNotEmpty())
               ...
               <tr>
                ...
                <td>
                  ...
                  <img src="{{asset('uploads/products/small/'.$productImage->image)}}" class="img-thumbnail" width="75" >
                  @endif
