            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="code" value="{{$coupon->code}}" id="code" class="form-control"  placeholder="Code">	
                  <p></p>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="name" value="{{$coupon->name}}" id="name" class="form-control"  placeholder="Name">	
              <p></p>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="number" name="max_uses" value="{{$coupon->max_uses}}" id="max_uses" class="form-control"  placeholder="Max Uses">	
                  <p></p>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="max_uses_user" value="{{$coupon->max_uses_user}}" id="max_uses_user" class="form-control"  placeholder="Max Uses User">	
                  <p></p>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="discount_amount" value="{{$coupon->discount_amount}}" id="discount_amount" class="form-control"  placeholder="Discount Amount">	
                  <p></p>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="min_amount" value="{{$coupon->min_amount}}" id="min_amount" class="form-control"  placeholder="Min Amount">	
                  <p></p>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="starts_at" value="{{$coupon->starts_at}}" id="starts_at" class="form-control"  placeholder="Starts At">	
                  <p></p>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="expires_at" value="{{$coupon->expires_at}}" id="expires_at" class="form-control"  placeholder="Expires At">	
                  <p></p>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                 ...
                 <textarea name="description" id="description" cols="30" rows="5" class="form-control" placeholder="Description">{{$coupon->description}}</textarea>
                 <p></p>
