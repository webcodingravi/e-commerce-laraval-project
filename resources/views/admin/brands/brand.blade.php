  ...
  <section class="content-header">					
    <div class="container-fluid my-2">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <h1>Brands <a href="{{route('brands.export')}}" style="font-size: 1.7rem">
      ...
      <div class="card">
        ...
        <div class="card-header">
         <div class="card-title">
          <button class="btn btn-info btn-sm" onclick="window.location.href='{{route("brand.index")}}'">Reset</button>
         </div>
          ...
          <table class="table table-hover table-bordered table-striped text-nowrap">
            ...
            <tbody>
             ...
             @endforeach
              ...
              @else
              <tr>
                <td colspan="5"><h2>No, Record Found</h2></td>
              </tr>
