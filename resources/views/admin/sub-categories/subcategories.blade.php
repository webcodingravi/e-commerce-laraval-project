  ...
  <section class="content-header">					
    <div class="container-fluid my-2">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <h1>Sub Category <a href="{{route('subCategory.export')}}" style="font-size: 1.7rem">
        ...
        <form action="" method="get">
          <div class="card-header">
            <div class="card-title">
              <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{route("sub-categories.index")}}'">
                Reset</button>
            </div>
        ...
        <div class="card-body table-responsive p-0">								
          <table class="table table-hover table-bordered table-striped text-nowrap">
            ...
            <tbody>
              ...
              @else
              <tr>
                <td colspan="6"><h2>No, Record Found</h2></td>
