  ...
  <section class="content-header">					
    <div class="container-fluid my-2">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <h1>Categories <a href="{{route('category.export')}}" style="font-size: 1.7rem">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <div class="card-title">
            <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{route("categories.index")}}'">
              Reset</button>
          </div>
