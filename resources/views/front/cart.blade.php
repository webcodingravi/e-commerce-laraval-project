                          ...
                          <tr>
                              <td class="text-start">
                                  <div class="d-flex align-items-center">
                                      ...
                                      <img  src="{{asset('/uploads/products/small/'.$item->options->productImage->image)}}" alt="">
                              ...
                              <td>
                                  <button onclick="deletItem('{{$item->rowId}}')" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button>
                              </td>
                          </tr>
                          @endforeach
