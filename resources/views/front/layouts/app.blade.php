		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="{{route('front.home')}}" class="text-decoration-none">
					<img src="{{asset('img/online shop.png')}}" style="width: 100px" alt="">
			...
			<div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
				...
				<a href="{{route('account.profile')}}" class="nav-link text-dark">
					<i class="fas fa-user fs-4"></i> My Account</a>
					@else
					<a href="{{route('account.login')}}" class="nav-link text-dark">
						<i class="fas fa-user fs-4"></i> Login / Register</a>
				@endif
		...
		<nav class="navbar navbar-expand-xl" id="navbar">
          ...
          @endif
			...
			<div class="right-nav py-0">
				<a href="{{route('front.cart')}}" class="ml-3 d-flex pt-2 mt-1">
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright {{date('Y')}} Online Shop. All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal" id="wishistModal" aria-labelledby="wishistModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fs-5" id="wishistModalLabel">Success</h5>
...
function addToCart(id) {
		...
		function addToWishlist(id) {
           ...
           success: function(response) {
              if(response.status == true) {
								$("#wishistModal .modal-body").html(response.message);
								$("#wishistModal").modal('show');
              }else{
