              ...
              <div class="card payment-form ">                        
                  <h3 class="card-title h5 mb-3">Payment Method</h3>
                    ...
                    <div class="mb-3">
                     ...
                     <input type="radio" name="payment_method" id="payment_method_one" value="cod" checked>
                     <lable for="payment_method_one">COD</lable>

                     <input type="radio" name="payment_method" id="payment_method_two" class="ms-2" value="stripe">
                     <lable for="payment_method_two">Stripe</lable>
                  </div>
...
$("#apply-discount").click(function() {
  $.ajax({
      ...
      data: {
        "_token": "{{ csrf_token() }}",
        code: $("#discount_code").val(), country_id: $("#country").val() },
      dataType: 'json',
      success: function(response) {
        if(response.status == true) {
          $("#shippingAmount").html("₹"+response.shippingCharge);
