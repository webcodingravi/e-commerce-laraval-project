                      ...
                      <div class="col-12 pb-1">
                          ...
                          <div class="d-flex align-items-center justify-content-end mb-3">
                            <div class="all-product">
                                <a href="{{route('front.shop')}}" class="nav-link text-dark fw-bold">All </a>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-2">
                            <div class="product-grid">
                                <div class="product-image">
                                    ...
                                    <a href="{{route('front.product',$product->slug)}}" class="product-img"><img class="card-img-top" src="{{asset('/uploads/products/small/'.$productImage->image)}}" alt="">
  
                                     @else 
                                     <a href="" class="product-img"><img class="card-img-top" src="{{asset('/uploads/products/no-image.jpg')}}" alt="">
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="price">
                                            ...
                                            <span>₹{{number_format($product->compare_price,2)}}</span>
                                            @endif
                                    ...
                                    <ul class="product-links">
                                        ...
                                        <li><a href="javascript:void(0)" onclick="addToCart({{$product->id}})">Add to Cart</a></li>
                                        ...
                                        @endif
                                        <li><a href="javascript:void(0)" onclick="addToWishlist({{$product->id}})"><i class="far fa-heart"></i></a></li>
